...
export default function FavoritesDropdown() {
  ...
  return (
    <div className="fixed right-3 top-28 z-[95] sm:right-5 sm:top-24">
      <button
        type="button"
      ...
      {open && (
        <div className="mt-3 w-[min(86vw,22rem)] overflow-hidden rounded-[24px] border border-white/10 bg-[#080812]/95 shadow-[0_24px_80px_rgba(0,0,0,0.75)] backdrop-blur-2xl">
