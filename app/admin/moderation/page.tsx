      ...
      <div className="max-w-5xl mx-auto space-y-6">
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex gap-2 text-[11px] uppercase font-black">
            <Link href="/admin/moderate" className="px-3 py-2 rounded-lg bg-white/5 border border-white/10 hover:border-amber-500 hover:text-amber-400 transition">← მთავარ პანელზე</Link>
