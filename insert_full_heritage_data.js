...
async function insertAllHeritageData() {
  try {
    ...
    const heritageData = [
      ...
      { category: 'ღვინის კულტურა', title: 'ქვევრის დამზადების ტრადიცია', description: 'კახური მეღვინეობის საფუძველი ქვევრია. სოფელ ვარდისუბანში დღემდე ცხოვრობენ მექვევრეები, რომლებიც ამ ხელობას თაობიდან თაობას გადასცემენ.', fun_fact: 'იცოდით, რომ იუნესკომ ქვევრის ღვინის დაყენების მეთოდს არამატერიალური კულტურული მემკვიდრეობის სტატუსი მიანიჭა?', image_url: 'https://images.unsplash.com/photo-1510812431401-41d2bd2722f3', location_name: 'ვარდისუბანი' },
      { category: 'ღვინის კულტურა', title: 'რქაწითელი - კახეთის ოქრო', description: 'თეთრი ყურძნის ჯიში, რომელიც კახეთში ყველაზე მეტადაა გავრცელებული და მისგან საუკეთესო ქვევრის ღვინო დგება.', fun_fact: 'იცოდით, რომ რქაწითელი ერთ-ერთი უძველესი ჯიშია მსოფლიოში და მისი წიპწები ნეოლითის ხანის ნამოსახლარებშია ნაპოვნი?', image_url: 'https://images.unsplash.com/photo-1506377247377-2a5b3b0ca7ef', location_name: 'ალაზნის ველი' },
      { category: 'ღვინის კულტურა', title: 'საფერავი - ქართული სიამაყე', description: 'წითელი ყურძნის ჯიში, რომელსაც "თვითმღებავს" უწოდებენ, რადგან მისი რბილობიც კი შეფერილია.', fun_fact: 'იცოდით, რომ საფერავი ერთ-ერთია იმ მცირერიცხოვან ჯიშებს შორის, რომლისგანაც ექსტრემალურად მუქი, თითქმის შავი ღვინო მიიღება?', image_url: 'https://images.unsplash.com/photo-1547595628-c61a29f496f0', location_name: 'კახეთი' },

      // Famous People (10 items)
      { category: 'ცნობილი ადამიანები', title: 'მეფე ერეკლე II', description: 'კახეთის ლეგენდარული მეფე, "პატარა კახი", რომელიც მთელი ცხოვრება ბრძოლებში გაატარა ქვეყნის გადასარჩენად.', fun_fact: 'იცოდით, რომ ერეკლე II-მ 80-მდე დიდი და მცირე ბრძოლა გადაიხადა და თითქმის ყოველთვის გამარჯვებული გამოდიოდა?', image_url: 'https://images.unsplash.com/photo-1580618672591-eb180b1a973f', location_name: 'თელავი' },
      { category: 'ცნობილი ადამიანები', title: 'ნიკო ფიროსმანი', description: 'გენიალური თვითნასწავლი მხატვარი მირზაანიდან, რომლის ნახატებმაც მსოფლიო აღიარება მოიპოვა.', fun_fact: 'იცოდით, რომ ფიროსმანის ცნობილი ისტორია "მილიონი ვარდის" შესახებ ნამდვილ ამბავს ეფუძნება, რომელიც მას ფრანგი მსახიობის მიმართ ჰქონდა?', image_url: 'https://images.unsplash.com/photo-1579783902614-a3fb3927b6a5', location_name: 'მირზაანი' },
      { category: 'ცნობილი ადამიანები', title: 'ალექსანდრე ჭავჭავაძე', description: 'პოეტი, გენერალი და საზოგადო მოღვაწე, რომელმაც წინანდლის მამული კულტურული ცენტრად აქცია.', fun_fact: 'იცოდით, რომ ალექსანდრე ჭავჭავაძემ პირველმა შემოიტანა საქართველოში ფორტეპიანო და ევროპული ეტლი?', image_url: 'https://images.unsplash.com/photo-1505664194779-8beaceb93744', location_name: 'წინანდალი' },

      // Legends (5 items for now)
      { category: 'ლეგენდები', title: 'სიღნაღი - სიყვარულის ქალაქი', description: 'ლეგენდა ამბობს, რომ სიღნაღში ნებისმიერ დროს შეგიძლიათ დაქორწინება და აქაური ჰაერი სიყვარულითაა გაჟღენთილი.', fun_fact: 'იცოდით, რომ სიღნაღში ქორწინების სახლი 24 საათის განმავლობაში მუშაობს და ნებისმიერ მსურველს იღებს?', image_url: 'https://images.unsplash.com/photo-1565620851603-467434151755', location_name: 'სიღნაღი' }
    ];
