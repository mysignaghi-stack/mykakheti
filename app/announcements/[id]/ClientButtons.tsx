...
export default function ClientButtons({ ad, shareUrl }: ClientButtonsProps) {
  ...
  return (
    <div className="space-y-3 relative z-10 mt-5 md:mt-6">
      ...
      <div className="grid grid-cols-2 gap-4">
         <button 
           ...
           className="flex items-center justify-center gap-2 bg-blue-600/10 border border-blue-500/20 py-3 rounded-[18px] hover:bg-blue-600 hover:text-white transition-all group"
         >
         ...
         <button 
           onClick={copyLink}
           className="flex items-center justify-center gap-2 bg-white/5 border border-white/10 py-3 rounded-[18px] hover:bg-white hover:text-black transition-all group"
         >
