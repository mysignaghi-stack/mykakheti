...
export default function SubmitForm() {
  ...
  return (
    <div className="bg-slate-950/80 backdrop-blur-3xl rounded-[50px] shadow-[0_32px_64px_-16px_rgba(0,0,0,0.5)] p-10 md:p-14 border border-white/10 relative overflow-hidden mt-10">
