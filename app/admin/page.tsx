...
const ADMIN_SECTIONS = [
  ...
  {
    title: 'ანალიტიკა და შედეგები',
    description: 'რეგისტრაციების, განცხადებების, სერვისების და საკონტაქტო ქმედებების გაზომვის კონტროლი.',
    links: [
      { href: '/admin/analytics', title: 'GA4 / Search Console / Meta Pixel', desc: 'ანალიტიკის სტატუსი, ძირითადი მოვლენები და ოფიციალურ პანელებზე გადასვლა.', accent: 'emerald' },
    ],
  },
  {
